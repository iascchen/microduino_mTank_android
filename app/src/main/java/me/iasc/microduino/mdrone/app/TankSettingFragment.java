...
public class TankSettingFragment extends DialogFragment
{
    private static final String TAG = TankSettingFragment.class.getSimpleName();

    public static final String SET_RIGHT_HAND = "tank_right_HAND";
//    public static final String SET_BLE_SEND_INTERVAL = "tank_ble_send_interval";
//    public static final String SET_BLOCK_SEND_INTERVAL = "tank_block_send_interval";
    public static final String SET_BLE_ADDRESS = "tank_ble_ADDRESS";
    public static final String SET_WEB_CAM_ADDRESS = "tank_web_cam_ADDRESS";

    private TankControlActivity parentActivity;
     ...
     */
    public static TankSettingFragment newInstance() {
        TankSettingFragment fragment = new TankSettingFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentActivity = (TankControlActivity) getActivity();
