...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "me.iasc.ble.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "me.iasc.ble.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "me.iasc.ble.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "me.iasc.ble.ACTION_DATA_AVAILABLE";
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        Log.v(TAG, "broadcastUpdate : " + characteristicUuid + " , " + GattUtils.byteArrayToHexString(value));
